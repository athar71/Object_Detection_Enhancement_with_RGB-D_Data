...
def train_model(model_dict, dataset_generators, epoch_n, print_every):
    with model_dict['graph'].as_default(), tf.Session() as sess:
        ...
        test_writer = tf.summary.FileWriter('Summary_rgbd_Ati1/',graph=model_dict['graph'])
...
train_model(model_dict, dataset_generators, epoch_n=20, print_every=50)                    
